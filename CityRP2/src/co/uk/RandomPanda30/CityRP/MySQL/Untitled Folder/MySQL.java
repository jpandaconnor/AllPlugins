...
public class MySQL extends Database {
	...
	public MySQL (CityRP plugin, String HOST, String DB_NAME, String USER,
		...
		try {
			openConnection();
			MessageUtil.sendMessage((String) Messages.MYSQL_LOADING.value,
					null);
		} catch (ClassNotFoundException | SQLException e) {
			new ExceptionUtil(e.getStackTrace(), Cause.MYSQLERROR,
					"Failed to open connection in the constructor");
			MessageUtil.sendMessage((String) Messages.MYSQL_BADSETTINGS.value,
					null);
