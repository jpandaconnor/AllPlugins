package co.uk.RandomPanda30.Handler;
...
public class MessageH {
	...
	public static String loadingBasics = white + "[" + aqua + "ServerBasics"
			+ white + "] " + green + "Loading!";
	public static String closingBasics = white + "[" + aqua + "ServerBasics"
			+ white + "] " + red + "Closing!";
	public static String madeBy = white + "[" + aqua + "ServerBasics" + white
	...
	public static void sendAdminsMessage(String sender, String message) {
		List<String> adminNames = Main.plugin.getConfig().getStringList(
				"adminNames");
