...
public class Events {
	...
	public static void registerEvents() {
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(pje,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(ple,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(pie,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(ice,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(bpe,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(bbe,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(wce,
				MurgeData.getPlugin());
		...
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(ede,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager()
				.registerEvents(ppie, MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(bie,
				MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager()
				.registerEvents(ede2, MurgeData.getPlugin());
		MurgeData.getPlugin().getServer().getPluginManager().registerEvents(pce,
				MurgeData.getPlugin());
	}
}