...
public class TreeRegenExecutor implements ExecutorBase2 {

	private static TreeRegenExecutor instance = new TreeRegenExecutor();

	public static TreeRegenExecutor getExecutor() {
		return instance;
	}
	...
	public void startTimer(int value) {
		Murge.treeChecker = new OreRegenTimer(MurgeData.getPlugin())
