...
public enum MessagesValues {
	...
	PURGE_ALREADYON {
		public Object getValue() {
			return "%TAG %EThe purge is already active!";
		}
	},

	PURGE_ALREADYOFF {
		public Object getValue() {
			return "%TAG %EThe purge is not active!";
		}
	},

	COMMAND_NOTENABLED {
		public Object getValue() {
			return "%TAG %EThis command is not enabled in the config";
		}
	},

	NOPERMISSION {
		public Object getValue() {
			return "%TAG %EYou do not have permission to do this!";
		}
	},
	...
	HELP_BADSYNTAX {
		public Object getValue() {
			return "%TAG %EError, something went wrong with this command. Do %A/murge list %Efor a list of commands";
		}
	},
	...
	WB_RESET {
		public Object getValue() {
			return "%TAG %NThe world border has been reset";
		}
	},

	WB_ALREADYDISABLED {
		public Object getValue() {
			return "%TAG %EThe world border is already disabled";
		}
	},
	...
	REGEN_MAYLAG {
		public Object getValue() {
			return "%TAG %E&lThe server is regenerating ores + trees. Expect some lag!";
		}
	},
	...
	SETUP_ENTERKITNAME {
		public Object getValue() {
			return "%TAG %NPlease open the chat and type the name of the kit you want to create";
		}
	},

	SETUP_ENTERKITCOOLDOWN {
		public Object getValue() {
			return "%TAG %NOk, now please enter the cooldown time you want for the kit. For example %A2d5h2m30s";
		}
	},

	SETUP_KITMADE {
		public Object getValue() {
			return "%TAG %NKit created!";
		}
	};
